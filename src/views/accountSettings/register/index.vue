  ...
  <div class="login-container">
    <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" auto-complete="on" label-position="left">
      ...
      <el-row>
        <el-col span="16">
          <el-form-item prop="password">
            ...
            <el-input :key="passwordType" ref="password" v-model="loginForm.password" :type="passwordType" placeholder="验证码"
              name="password" tabindex="2" auto-complete="on" @keyup.enter.native="handleLogin" style="width:50%" />

          </el-form-item>
        </el-col>

        <el-col span="6" :offset="2">
          <el-button type="primary" style="" @click.native.prevent="handleLogin" style="margin-top:6px">发送验证码</el-button>
        </el-col>
      ...
      <el-row style="padding-bottom:6px">
        <el-col>
          <el-checkbox v-model="checked" style="margin-right:0;"></el-checkbox>
          <el-button type="text" @click.native.prevent="openAgreement">我已阅读并同意《飞洛用户协议》</el-button>
        </el-col>
      </el-row>
      ...
      <el-row>
        <el-col style="text-align:center;color:#999;font-size:14px;">
          已有账号？
          <el-button type="text" @click.native.prevent="$router.push('login')">登录已有账号 >></el-button>
        </el-col>
      </el-row>
