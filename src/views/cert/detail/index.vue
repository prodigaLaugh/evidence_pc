    ...
    <div class="container">
      ...
      <div class="cerInfoWrap">
        ...
        <div class="cerInfoListWrap">
          ...
          <Detail :leftText="'存证号：129918293293'" :rightText="'存证名称：ddd'" />
          <Detail :leftText="'存证类型：文件存证'" :rightText="'存证来源：北京市'" />
          <Detail :leftText="'共享对象：--'" :rightText="'确认函：北京市'" />
        </div>

        <div class="cerInfoListWrap">
          <div class="title">区块链信息</div>
          <Detail :leftText="'上链时间：2019-11-25 16:52:15'" :rightText="'所属区块链：印刻链'" />
          <Detail :leftText="'存证Hash：5cbc7037c0fa61fb3ba9d6479fef0cbd'" :rightText="'交易Hash：0x94a2c190da08ba02abb1c5e7ebab6a2'" />
        </div>
